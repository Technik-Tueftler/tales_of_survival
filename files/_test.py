...
#     # channel_id = 1212120587582054444
#     # channel = self.bot.get_channel(channel_id)
#     # if channel is not None:
#     #     await channel.send("Deine Nachricht hier!")
#     # else:
#     #     # Wenn der Channel nicht gefunden wird (meist weil er noch nicht gecached ist)
#     #     channel = await self.bot.fetch_channel(channel_id)
#     #     await channel.send("Deine Nachricht hier 2!")